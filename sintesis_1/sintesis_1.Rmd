...
$$
es **costo computacionalmente**. Con la idea de facilitar los cálculos, surgen los Modelo ocultos de Markov (HMM, por sus siglas en inglés) que asumen:
...
$$
\hat{t}_1^n = \arg\max_{t_1^n}P(w_1^n|t_1^n)P(t_1^n)\approx P(w_i|t_i) P(t_i|t_{i-1})
$$
